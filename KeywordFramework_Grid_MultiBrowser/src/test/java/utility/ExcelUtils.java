...
public static void setCellData(String Result,  int RowNum, int ColNum, String SheetName, String DataSheet) throws Exception    {
	   try{
		   ...
		   if (Cell == null) {
			...
			FileOutputStream fileOut = new FileOutputStream(DataSheet);
			ExcelWBook.write(fileOut);
			//fileOut.flush();
			fileOut.close();
			ExcelWBook = new XSSFWorkbook(new FileInputStream(DataSheet));
		 }catch(Exception e){
			DriverScriptTest.bResult = false;
			}
		}
